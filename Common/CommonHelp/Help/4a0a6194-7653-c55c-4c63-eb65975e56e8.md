...
#### Parameters
<dl><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a></dt><dd>String value.</dd><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.string" target="_blank" rel="noopener noreferrer">String</a>  (Optional)</dt><dd>Array item delimiter string.</dd><dt>  <a href="https://learn.microsoft.com/dotnet/api/system.stringsplitoptions" target="_blank" rel="noopener noreferrer">StringSplitOptions</a>  (Optional)</dt><dd>String splitting options.</dd></dl>

#### Type Parameters
<dl><dt /><dd>Data type of the array elements.</dd></dl>
