...
using DotNetExtras.Types;

namespace CommonLibTests.Extensions;

public class ObjectEquivalencyExtensionsTests
{
    [Fact]
    public void IsEquivalentTo_Boolean()
    {
    ...
    [Fact]
    public void IsEquivalentTo_Enum()
    {
    ...
    [Fact]
    public void IsEquivalentTo_String()
    {
        string s1 = "ABC";
        string s2 = "ABC";
    ...
    [Fact]
    public void IsEquivalentTo_Integer()
    {
        short n1 = 1;
    ...
    [Fact]
    public void IsEquivalentTo_DateTime()
    {
        string s;
    ...
    [Fact]
    public void IsEquivalentTo_DateTimeOffset()
    {
        string s;
    ...
    [Fact]
    public void IsEquivalentTo_ArrayNumeric()
    {
        int[] aInt1 = [1, 2, 3,];
        int[] aInt2 = [1, 2, 3,];
    ...
    [Fact]
    public void IsEquivalentTo_StringCollections()
    {
    ...
    [Fact]
    public void IsEquivalentTo_Dictionary()
    {
    ...
    [Fact]
    public void IsEquivalentTo_Class()
    {
        User u1 = new()
        {
            Name = new()
